...
!function(n, t) {
    ...
    function ut(n) {
        return null == n ? n + "" : "object" == typeof n || "function" == typeof n ? ri[br.call(n)] || "object" : typeof n
    }
    function pi(n) {
    ...
    function at(n, t, f, o) {
        ...
        if (p && (b = (a = pu(t, n[0].ownerDocument, !1, n, o)).firstChild,
        ...
        b || o)) {
            ...
            if (v)
                ...
                c = 0; c < v; c++)
                    h = l[c],
                    vu.test(h.type || "") && !r.access(h, "globalEval") && i.contains(y, h) && (h.src && "module" !== (h.type || "").toLowerCase() ? i._evalUrl && !h.noModule && i._evalUrl(h.src, {
                        nonce: h.nonce || h.getAttribute("nonce")
                    }, y) : dr(h.textContent.replace(ke, ""), h, y))
        }
        return n
    }
    function ku(n, t, r) {
    ...
    function ni(n, t, r) {
        var o, s, h, u, c = ir.test(t), f = n.style;
        return (r = r || ci(n)) && (u = r.getPropertyValue(t) || r[t],
        c && (u = u.replace(to, "$1")),
        "" !== u || st(n) || (u = i.style(n, t)),
        !e.pixelBoxStyles() && tr.test(u) && no.test(t) && (o = f.width,
        s = f.minWidth,
        h = f.maxWidth,
    ...
    function rr(n) {
        var t = i.cssProps[n] || uf[n];
        return t || (n in rf ? n : uf[n] = function(n) {
            for (var i = n[0].toUpperCase() + n.slice(1), t = tf.length; t--; )
                if ((n = tf[t] + i)in rf)
                    return n
        }(n) || n)
    }
    ...
    function of(n, t, r) {
        ...
        (s = h in n) && (u = n[h])),
        (u = parseFloat(u) || 0) + ur(n, t, r || (o ? "border" : "content"), s, f, u) + "px"
    }
    function a(n, t, i, r, u) {
        return new a.prototype.init(n,t,i,r,u)
    }
    function fr() {
        li && (!1 === f.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(fr) : n.setTimeout(fr, i.fx.interval),
        i.fx.tick())
    }
    function lf() {
    ...
    function cr(n, t, r, u) {
        ...
        if (Array.isArray(t))
            i.each(t, function(t, i) {
                r || uo.test(n) ? u(n, i) : cr(n + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, r, u)
            });
    ...
    var p = [], pr = Object.getPrototypeOf, k = p.slice, wr = p.flat ? function(n) {
        return p.flat.call(n)
    }
    : function(n) {
        return p.concat.apply([], n)
    }
    , yi = p.push, ii = p.indexOf, ri = {}, br = ri.toString, ui = ri.hasOwnProperty, kr = ui.toString, oe = kr.call(Object), e = {}, u = function(n) {
        ...
        nonce: !0,
        noModule: !0
    }, gr = "3.6.1", i = function(n, t) {
        return new i.fn.init(n,t)
    }, d, wi, iu, ru, uu, fu, l, su, ei, ot, dt, ki, h, yu, gi, vt, li, yt, sf, hf, cf, vf, pt, yf, pf, wf, or, sr, ie, wt, re, yr, vi, ue, fe, ee;
    i.fn = i.prototype = {
        jquery: gr,
        constructor: i,
        length: 0,
    ...
    ;
    i.extend({
        expando: "jQuery" + (gr + Math.random()).replace(/\D/g, ""),
        isReady: !0,
        error: function(n) {
            throw new Error(n);
        },
        ...
        isPlainObject: function(n) {
            var t, i;
            return !(!n || "[object Object]" !== br.call(n)) && (!(t = pr(n)) || "function" == typeof (i = ui.call(t, "constructor") && t.constructor) && kr.call(i) === oe)
        },
    ...
    i.fn.extend({
        ...
        is: function(n) {
            return !!bi(this, "string" == typeof n && tu.test(n) ? i(n) : n || [], !1).length
        }
    });
    ru = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (i.fn.init = function(n, t, r) {
        ...
        if (r = r || iu,
        "string" == typeof n) {
            if (!(e = "<" === n[0] && ">" === n[n.length - 1] && 3 <= n.length ? [null, n, null] : ru.exec(n)) || !e[1] && t)
    ...
    i.each({
        ...
        next: function(n) {
            return eu(n, "nextSibling")
        },
        prev: function(n) {
            return eu(n, "previousSibling")
        },
        nextAll: function(n) {
        ...
        siblings: function(n) {
            return nu((n.parentNode || {}).firstChild, n)
        },
        children: function(n) {
            return nu(n.firstChild)
        },
        contents: function(n) {
            return null != n.contentDocument && pr(n.contentDocument) ? n.contentDocument : (c(n, "template") && (n = n.content || n),
        ...
        i.fn[n] = function(r, u) {
            ...
            1 < this.length && (fu[n] || i.uniqueSort(f),
            uu.test(n) && f.reverse()),
            this.pushStack(f)
        }
    });
    ...
    i.extend({
        ...
        when: function(n) {
            ...
            if (e <= 1 && (ou(n, r.done(s(t)).resolve, r.reject, !e),
    ...
    su = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
    i.Deferred.exceptionHook = function(t, i) {
        n.console && n.console.warn && t && su.test(t.name) && n.console.warn("jQuery.Deferred exception: " + t.message, t.stack, i)
    }
    ;
    ...
    i.fn.extend({
        data: function(n, t) {
            ...
            return "object" == typeof n ? this.each(function() {
                ...
                var r;
                if (i && void 0 === t)
                    return void 0 !== (r = o.get(i, n)) ? r : void 0 !== (r = hu(i, n)) ? r : void 0;
                this.each(function() {
                    o.set(this, n, t)
                })
    ...
    var cu = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
      , kt = new RegExp("^(?:([+-])=|)(" + cu + ")([a-z%]*)$","i")
    ...
    var nt, si, gt = /^(?:checkbox|radio)$/i, au = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, vu = /^$|^module$|\/(?:java|ecma)script/i;
    ...
    i.fn.extend({
        ...
        append: function() {
            return at(this, arguments, function(n) {
                1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType || wu(this, n).appendChild(n)
            })
        },
        prepend: function() {
            return at(this, arguments, function(n) {
        ...
        html: function(n) {
            return w(this, function(n) {
                ...
                if (void 0 === n && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof n && !we.test(n) && !h[(au.exec(n) || ["", ""])[1].toLowerCase()]) {
                    n = i.htmlPrefilter(n);
                    try {
                        for (; r < u; r++)
    ...
    i.extend({
        ...
        style: function(n, t, r, u) {
            if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
                ...
                "string" == (h = typeof r) && (f = kt.exec(r)) && f[1] && (r = lu(n, t, f),
                h = "number");
    ...
    i.each(["height", "width"], function(n, t) {
        i.cssHooks[t] = {
            get: function(n, r, u) {
                if (r)
                    return !io.test(i.css(n, "display")) || n.getClientRects().length && n.getBoundingClientRect().width ? of(n, t, u) : du(n, ro, function() {
                        return of(n, t, u)
                    })
            },
            set: function(n, r, u) {
                var s, f = ci(n), h = !e.scrollboxSize() && "absolute" === f.position, c = (h || u) && "border-box" === i.css(n, "boxSizing", !1, f), o = u ? ur(n, t, u, c, f) : 0;
                return c && h && (o -= Math.ceil(n["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(f[t]) - ur(n, t, "border", !1, f) - .5)),
    ...
    i.cssHooks.marginLeft = nf(e.reliableMarginLeft, function(n, t) {
        if (t)
            return (parseFloat(ni(n, "marginLeft")) || n.getBoundingClientRect().left - du(n, {
                marginLeft: 0
            }, function() {
    ...
    i.each({
        ...
        "margin" !== n && (i.cssHooks[n + t].set = ef)
    });
    i.fn.extend({
        css: function(n, t) {
    ...
    (a.propHooks = {
        _default: {
            ...
            set: function(n) {
                i.fx.step[n.prop] ? i.fx.step[n.prop](n) : 1 !== n.elem.nodeType || !i.cssHooks[n.prop] && null == n.elem.style[rr(n.prop)] ? n.elem[n.prop] = n.now : i.style(n.elem, n.prop, n.now + n.unit)
            }
        }
    ...
    i.Animation = i.extend(v, {
        tweeners: {
            "*": [function(n, t) {
                ...
                return lu(i.elem, n, kt.exec(t), i),
                i
            }
            ]
        },
    ...
    i.fn.extend({
        addClass: function(n) {
            ...
            }) : (f = er(n)).length ? this.each(function() {
                if (e = it(this),
                t = 1 === this.nodeType && " " + tt(e) + " ") {
        ...
        removeClass: function(n) {
            ...
            }) : arguments.length ? (f = er(n)).length ? this.each(function() {
                if (e = it(this),
                t = 1 === this.nodeType && " " + tt(e) + " ") {
                    for (r = 0; r < f.length; r++)
                        for (o = f[r]; -1 < t.indexOf(" " + o + " "); )
                            t = t.replace(" " + o + " ", " ");
                    s = tt(t);
                    e !== s && this.setAttribute("class", s)
                }
        ...
        toggleClass: function(n, t) {
            ...
            }) : "boolean" == typeof t && c ? t ? this.addClass(n) : this.removeClass(n) : (s = er(n),
            this.each(function() {
                if (c)
                    for (o = i(this),
                    e = 0; e < s.length; e++)
                    ...
                    void 0 !== n && "boolean" !== h || ((f = it(this)) && r.set(this, "__className__", f),
    ...
    i.extend(i.event, {
        trigger: function(t, e, o, s) {
            ...
            if (c = p = l = o = o || f,
            3 !== o.nodeType && 8 !== o.nodeType && !or.test(h + i.event.triggered) && (-1 < h.indexOf(".") && (h = (b = h.split(".")).shift(),
            b.sort()),
            v = h.indexOf(":") < 0 && "on" + h,
            ...
            s || !a.trigger || !1 !== a.trigger.apply(o, e))) {
                ...
                i.event.triggered = h,
                t.isPropagationStopped() && p.addEventListener(h, sr),
                o[h](),
                t.isPropagationStopped() && p.removeEventListener(h, sr),
    ...
    var oo = /%20/g
      ...
      , lr = {}
      , gf = "*/".concat("*")
      , ar = f.createElement("a");
    return ar.href = ti.href,
    i.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajaxSetup: function(n, t) {
            return t ? vr(vr(n, i.ajaxSettings), t) : vr(i.ajaxSettings, n)
        },
        ajaxPrefilter: ne(df),
        ajaxTransport: ne(lr),
        ajax: function(t, r) {
            ...
            null == u.crossDomain) {
                ...
                try {
                    c.href = u.url;
                    c.href = c.href;
                    u.crossDomain = ar.protocol + "//" + ar.host != c.protocol + "//" + c.host
                } catch (t) {
                    u.crossDomain = !0
                }
            }
    ...
    i.ajaxSetup({
        ...
        jsonpCallback: function() {
            var n = yr.pop() || i.expando + "_" + bf.guid++;
            return this[n] = !0,
            n
        }
    }),
    i.ajaxPrefilter("json jsonp", function(t, r, f) {
        ...
        if (h || "jsonp" === t.dataTypes[0])
            ...
            h ? t[h] = t[h].replace(vi, "$1" + e) : !1 !== t.jsonp && (t.url += (hr.test(t.url) ? "&" : "?") + t.jsonp + "=" + e),
    ...
    i.parseHTML = function(n, t, r) {
        ...
        u = !r && [],
        (o = wi.exec(n)) ? [t.createElement(o[1])] : (o = pu([n], t, u),
    ...
    i.each(["top", "left"], function(n, t) {
        i.cssHooks[t] = nf(e.pixelPosition, function(n, r) {
            if (r)
                return r = ni(n, t),
...
var appModule = function() {
    ...
    function r() {
        jQuery().lazyload && $(".lazyload").lazyload()
    }
    function u() {
        $(document).on("click", ".menu-icon", function(n) {
            n.preventDefault();
            var t = $(this);
            t.next().slideToggle();
            t.parent().toggleClass("menu-open")
        });
        $(document).on("click", ".btn-submit", function(n) {
            n.preventDefault();
            $(this).closest("form").submit()
        });
        $(document).on("click", ".sidebar-toggle", function() {
            var n = $("#sidebardefault")
              , t = $(".sidebar-overlay");
            n.toggleClass("open");
            (n.hasClass("sidebar-fixed-left") || n.hasClass("sidebar-fixed-right")) && n.hasClass("open") ? t.addClass("active") : t.removeClass("active")
        });
        $(document).on("click", ".sidebar-overlay", function() {
            $(this).removeClass("active");
            $("#sidebardefault").removeClass("open")
        });
        $(document).on("click", ".rate_rating label", function(n) {
            n.preventDefault();
            var t = $(this)
              , i = t.closest(".rate_rating").data("id")
              , r = t.data("score")
              , u = t.closest(".row_rating").find(".rate_count:first")
              , f = t.closest(".rate_rating").find("label");
            typeof i != "undefined" && typeof r != "undefined" && $.ajax({
                cache: !1,
                url: "/TinTuc/RatingScore",
                type: "Post",
                data: {
                    articleId: i,
                    ratingScoreId: r
                ...
                success: function(n) {
                    if (console.log(n),
                    n != null && n.completed && n.data != null) {
                        var t = n.data;
                        u.length && u.html(t.stars + " / 5 trên " + t.total + " lượt đánh giá");
                        f.length && f.each(function() {
                            var n = $(this)
                              , i = n.data("score");
                            t.stars >= i ? n.hasClass("active") || n.addClass("active") : n.hasClass("active") && n.removeClass("active")
                        })
                    }
                },
                error: function() {}
    ...
    function f(n, t) {
        var r = $(n).attr("data-date")
          , i = $(n).val();
        $(".xs" + t + "_date_" + r + " tbody tr td p").each(function(n, t) {
            var r = $(t).attr("data-loto");
            typeof r != "undefined" && r != "..." && ((i == 2 || i == 3) && r.length > i && (r = r.substr(r.length - i)),
            $(t).text(r))
        })
    }
    function e() {
    ...
    function t() {
        var i = new Date
          ...
          , f = i.getMonth() + 1
          , s = i.getFullYear()
          , e = "kqngay_" + (u < 10 ? "0" + u : "" + u) + (f < 10 ? "0" + f : "" + f) + s
          , n = window.location.href
          , o = window.location.origin;
        n.indexOf("#") >= 0 && (n = n.split("#")[0]);
        n.indexOf("?") >= 0 && (n = n.split("?")[0]);
        r == 17 && t >= 10 && t <= 40 ? ($("#lottery_living_name").text("XSMT"),
        $("#curr_living_btn").attr("href", "/xsmt-xo-so-mien-trung/"),
        $("#live_hour").text("17h15"),
        (n == o + "/" || n.indexOf("/xsmt-xo-so-mien-trung/") >= 0) && $("#curr_living_btn").attr("href", "#mt_" + e),
        $("#curr_living_neo").show()) : r == 16 && t >= 10 && t <= 40 ? ($("#lottery_living_name").text("XSMN"),
        $("#curr_living_btn").attr("href", "/xsmn-xo-so-mien-nam/"),
        (n == o + "/" || n.indexOf("/xsmn-xo-so-mien-nam/") >= 0) && $("#curr_living_btn").attr("href", "#mn_" + e),
        $("#curr_living_neo").show()) : r == 18 && t >= 10 && t <= 40 ? ($("#lottery_living_name").text("XSMB"),
        $("#curr_living_btn").attr("href", "/xsmb-xo-so-mien-bac/"),
        (n == o + "/" || n.indexOf("/xsmb-xo-so-mien-bac/") >= 0) && $("#curr_living_btn").attr("href", "#" + e),
        $("#curr_living_neo").show()) : $("#curr_living_neo").hide()
    }
    function o() {
        $("#curr_living_btn").length && (t(),
        setInterval(function() {
            t()
        }, 3e4))
    }
    function s() {
        var n = $("input[name=CheckboxGroup]:checked");
        $(".show_dau").hasClass("fix-hide") || $(".show_dau").addClass("fix-hide");
        $(".show_duoi").hasClass("fix-hide") || $(".show_duoi").addClass("fix-hide");
        $(".show_de").hasClass("fix-hide") || $(".show_de").addClass("fix-hide");
        $(".show_tong").hasClass("fix-hide") || $(".show_tong").addClass("fix-hide");
        n.each(function() {
            var n = $(this).val();
            n == 1 && $(".show_dau").removeClass("fix-hide");
            n == 2 && $(".show_duoi").removeClass("fix-hide");
            n == 3 && $(".show_de").removeClass("fix-hide");
            n == 4 && $(".show_tong").removeClass("fix-hide")
        })
    }
    return ajaxEvents = {
        OnBegin: function() {
        ...
        OnSuccess: function(t) {
            if (t != null)
                if (t.message != null)
                    alert(t.message),
                    t.callback != null && t.callback.length > 0 && eval(atob(t.callback));
                else if (t.completed) {
                    if (t.returnUrl != null) {
